function getSteps(
  ...
  return [
    ...
    { label: "Primera venta", complete: hasSales },
  ];
}
    ...
    <section className="rounded-[2rem] border border-[#E2E8F0] bg-[linear-gradient(135deg,#FFFFFF_0%,#F8FAFC_58%,#EFF6FF_100%)] p-5 shadow-sm sm:p-6">
      ...
      <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:items-center">
        <button
          type="button"
          disabled
          className="rounded-full bg-[linear-gradient(135deg,#2563EB_0%,#06B6D4_100%)] px-5 py-3 text-sm font-black text-white opacity-60 shadow-lg shadow-cyan-500/20 disabled:cursor-not-allowed"
        >
